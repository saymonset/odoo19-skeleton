...
class HrEmployeeDocumentMixin(models.AbstractModel):
    _name = "hr.employee.document.mixin"
    _description = "Employee Document Mixin"
...
class HrEmployee(models.Model):
    _inherit = ["hr.employee", "hr.employee.document.mixin"]

class HrEmployeePublic(models.Model):
    _inherit = ["hr.employee.public", "hr.employee.document.mixin"]
