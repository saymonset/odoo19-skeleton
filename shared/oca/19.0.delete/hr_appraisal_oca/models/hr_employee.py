...
class HrAppraisalEmployeeMixin(models.AbstractModel):
    _name = "hr.appraisal.employee.mixin"
    _description = "Appraisal Employee Mixin"
...
class HrEmployee(models.Model):
    _name = "hr.employee"
    _inherit = ["hr.employee", "hr.appraisal.employee.mixin"]


class HrEmployeePublic(models.Model):
    _name = "hr.employee.public"
    _inherit = ["hr.employee.public", "hr.appraisal.employee.mixin"]
