...
def post_init_hook(env, employees=None):
    ...
    for employee in employees.filtered("version_ids"):
        contract_calendar_lines = []
        for contract in employee.version_ids.sorted("contract_date_start"):
            date_start = contract.contract_date_start
            date_end = contract.contract_date_end
        ...
        # set correct calendar in employee
        employee.resource_calendar_id = employee.resource_calendar_id
