...
exports.buildAccountSelectors = buildAccountSelectors;
...
function buildPlatformSelector() {
    return {
        ...
        description: "Select the platforms where you want to post your content. After selecting platforms, you'll be able to choose specific accounts for each platform.",
        required: true,
    };
}
/**
...
function buildMediaItemsField() {
    return {
        ...
        description: "Media files to attach to your post. Upload files first using 'Media > Upload', then use the returned URLs here. Supports up to 5GB per file.",
        options: [
            {
                name: "items",
                displayName: "Media Items",
                values: [
                    ...
                    },
                    {
                        ...
                        description: "URL of the uploaded media file from the /v1/media endpoint. You can use expressions like ={{ 'https://' + $json.data.color + '.com' }}",
                        placeholder: "https://getlate.dev/api/v1/media/uploaded-file-url.jpg",
                        required: true,
                    },
                    {
                    ...
                    },
                    {
                        ...
                        type: "string",
                        default: "",
                        description: "MIME type of the file. Required for documents (e.g., application/pdf)",
...
function buildCommonPostFields() {
    return [
        ...
        },
        {
            ...
            description: "Comma-separated tags/keywords for the post. Primarily used by YouTube for search optimization (500 char limit, ~15 tags max). Keep tags relevant and descriptive.",
...
function buildListFields() {
    return [
        ...
        },
        {
            ...
            options: [
                { name: "All", value: "" },
                ...platformHelpers_1.SUPPORTED_PLATFORMS.map((platform) => ({
                    name: platform.name,
                    value: platform.value,
                })),
            ],
